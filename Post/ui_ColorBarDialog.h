...
public:
    ...
    void setupUi(QDialog *ColorBarDialog)
    {
        ...
        verticalLayout_2 = new QVBoxLayout(contourTab);
        ...
        verticalLayout_2->addWidget(variableGroupBox);
        ...
        verticalLayout_2->addWidget(colorRangeGroupBox);
        ...
        verticalLayout_2->addWidget(colorMapGroupBox);

        verticalSpacer = new QSpacerItem(20, 337, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        Wi_Expan = new QWidget(legendTitleGroupBox);
        Wi_Expan->setObjectName(QString::fromUtf8("Wi_Expan"));
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Expanding);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(Wi_Expan->sizePolicy().hasHeightForWidth());
        Wi_Expan->setSizePolicy(sizePolicy);

        legendTitleLayout->addWidget(Wi_Expan);
    ...
    void retranslateUi(QDialog *ColorBarDialog)
    {
        ...
        textLegendXPosition->setPlaceholderText(QCoreApplication::translate("ColorBarDialog", "80", nullptr));
